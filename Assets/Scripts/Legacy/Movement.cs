...
namespace Legacy
{
    public class Movement : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            //possibleVelocity = new Vector3(Mathf.Clamp(possibleVelocity.x + rb.velocity.x * Time.fixedDeltaTime, -speed, speed) , Mathf.Clamp(possibleVelocity.y + rb.velocity.y * Time.fixedDeltaTime, -speed, speed), 0f);
